		...
		<>
			<div className='blur-this fixed top-0 z-[200] h-[64px] w-full border-b-4 border-teamdao_green'>
				<div className='relative z-50 flex items-center'>
					<Link
						href='/'
						className='absolute left-2 z-50 rounded-xl bg-black px-2 py-3'
					>
						<Image
							src='/teamdao-log.svg'
							alt='Logo'
			...
			<AnimatePresence>
				{menuOpen && (
					<motion.div
						...
						className='backdrop-blur-lg bg-black/55 fixed left-3 right-3 z-[500] mt-20 block rounded-2xl p-4 text-white xl:hidden'
					>
