...
export default function ConnectWalletBTN() {
	return (
		<div>
			<Wallet>
				<ConnectWallet className='flex h-[45px] items-center border-2 border-teamdao_green bg-black text-white outline-none transition-all duration-200 ease-in-out hover:bg-black active:scale-105'>
					<ConnectWalletText className='font-teamdao leading-[15px] text-white'>
						<div className='flex items-center space-x-2'>
							<Wallet2Icon />
							<span className='mt-0.5 select-none tracking-widest'>
								Connect
							</span>
						</div>
					</ConnectWalletText>
